...
@section('content')
    ...
    <form id="kt_add_form" class="form fv-plugins-bootstrap5 fv-plugins-framework"
          ...
          action="{{ route('dashboard.jobs.update', $job) }}" data-reload="1" method="POST">
        @method('PUT')
                                ...
                                <div class="col-6">
                                    ...
                                    <div class="fv-row mb-10 fv-plugins-icon-container">
                                        ...
                                        <textarea class="form-control form-control-solid" rows="5"
                                                  ...
                                                  placeholder="Enter a description">{{ $job->brief($language->code) }}</textarea>
                                        <!--end::Input-->
                                        <div class="fv-plugins-message-container invalid-feedback"></div>
                                    </div>
                                    <!--end::Input group-->
                            ...
                            @foreach($languages as $language)
                                <div class="col-6">
                                    ...
                                    <div class="fv-row mb-10 fv-plugins-icon-container">
                                        ...
                                        <!--end::Label-->
                                        <!--begin::Input-->
                                        <input class="form-control form-control-solid" value="{{ $job->tags($language->code) }}"
