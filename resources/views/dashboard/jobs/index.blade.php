...
@section('actions')
    ...
    <div class="me-3">
        ...
        <div class="menu menu-sub menu-sub-dropdown w-700px w-md-750px" data-kt-menu="true"
            ...
            <!--end::Menu separator-->
            <!--begin::Form-->
            <form id="search" action="{{ route('dashboard.jobs.index') }}">
                <div class="px-7 py-5">
                    <div class="row">
                        <div class="col-6">
                            <!--begin::Input group-->
    ...
    <!--end::Wrapper-->
    @can(get_permission('dashboard.jobs.create'))
        <!--begin::Button-->
        <a href="{{ route('dashboard.jobs.create') }}" class="btn btn-dark fw-bolder"
            ...
            <div class="col-xl-12">
                ...
                <div class="card bg-light-primary card-xl-stretch mb-5 mb-xl-8">
                    ...
                    <div class="card-body my-3">
                        ...
                        <div class="py-1">
                            <span class="text-dark fs-1 fw-bolder me-2">{{ $jobsQuery->count() }}</span>
                        </div>
                    </div>
                    <!--end:: Body-->
                </div>
            ...
            <div class="card-header border-0 pt-6">
                ...
                <div class="card-toolbar">
                    ...
                    <div class="d-flex justify-content-end" data-kt-customer-table-toolbar="base">
                        @canany(get_permission(['dashboard.bulk.jobs.delete']))
                            ...
                            <div
                                ...
                                data-kt-menu="true">
                                @can(get_permission('dashboard.bulk.jobs.delete'))
                                    <div class="menu-item px-3">
                                        <a data-url="{{ route('dashboard.bulk.jobs.delete') }}"
            ...
            <div class="card-body pt-0" style="overflow: scroll;width: 100%;">
                ...
                <table class="table align-middle table-row-dashed fs-6 gy-5" id="kt_subscriptions_table">
                    ...
                    <tr class="text-start text-muted fw-bolder fs-7 text-uppercase gs-0">
                        ...
                        @canany(get_permission(['dashboard.jobs.edit','dashboard.jobs.destroy']))
                            ...
                            @canany(get_permission(['dashboard.jobs.edit','dashboard.jobs.destroy']))
                                <td>
                                    ...
                                    <div
                                        class="menu menu-sub menu-sub-dropdown menu-column menu-rounded menu-gray-600 menu-state-bg-light-primary fw-bold fs-7 w-125px py-4"
                                        data-kt-menu="true">
                                        @can(get_permission('dashboard.jobs.edit'))
                                            <div class="menu-item px-3">
                                        ...
                                        @endcan
                                        @can(get_permission('dashboard.jobs.destroy'))
                                        <!--begin::Menu item-->
                                            <div class="menu-item px-3">
                                                <a data-url="{{ route('dashboard.jobs.destroy', $job) }}"
                                                   data-item-id="{{ $job->id }}"
                                                   data-bs-toggle="modal"
                                                   data-bs-target="#delete_modal"
                ...
                <!--end::Table-->
                {!! $jobs->appends(request()->except('page'))->links('vendor.pagination.default') !!}
            </div>
            <!--end::Card body-->
        </div>
        <!--end::Card-->
    @else
        @include('dashboard.includes.no-items',['module' => 'job','route' => route('dashboard.jobs.create'),'list_route' => route('dashboard.jobs.index')])
    @endif

    @include('dashboard.includes.delete-modal',['action_message' => 'job'])
@endsection
