...
@section('breadcrumb')
    ...
    <ul class="breadcrumb breadcrumb-dot fw-bold text-gray-600 fs-7 my-1">
        ...
        <!--end::Item-->
        <!--begin::Item-->
        <li class="breadcrumb-item text-gray-600">Sliders</li>
        <!--end::Item-->
    </ul>
    <!--end::Breadcrumb-->
@endsection
...
@section('actions')
    ...
    <!--end::Wrapper-->
    @can(get_permission('dashboard.sliders.create'))
        <!--begin::Button-->
        <a href="{{ route('dashboard.sliders.create') }}" class="btn btn-dark fw-bolder"
...
@section('content')
            ...
            <div class="col-xl-12">
                ...
                <div class="card bg-light-primary card-xl-stretch mb-5 mb-xl-8">
                    ...
                    <div class="card-body my-3">
                        <a href="#" class="card-title fw-bolder text-primary fs-5 mb-3 d-block">Total Sliders</a>
                        <div class="py-1">
                            <span class="text-dark fs-1 fw-bolder me-2">{{ $slidersQuery->count() }}</span>
                        </div>
                    </div>
                    <!--end:: Body-->
                </div>
    ...
    @if($sliders->count())
            ...
            <div class="card-header border-0 pt-6">
                ...
                <div class="card-title">
                    ...
                    <div class="d-flex align-items-center position-relative my-1">
                        ...
                        <form id="search" action="{{ route('dashboard.sliders.index') }}">
                            <input type="text" name="name" value="{{ request()->title }}"
                ...
                <div class="card-toolbar">
                    ...
                    <div class="d-flex justify-content-end" data-kt-customer-table-toolbar="base">
                        @canany(get_permission(['dashboard.bulk.sliders.delete']))
                            ...
                            <div
                                ...
                                data-kt-menu="true">
                                @can(get_permission('dashboard.bulk.sliders.delete'))
                                    <div class="menu-item px-3">
                                        <a data-url="{{ route('dashboard.bulk.sliders.delete') }}"
            ...
            <div class="card-body pt-0" style="overflow: scroll;width: 100%;">
                ...
                <table class="table align-middle table-row-dashed fs-6 gy-5" id="kt_subscriptions_table">
                    ...
                    <tr class="text-start text-muted fw-bolder fs-7 text-uppercase gs-0">
                        ...
                        @canany(get_permission(['dashboard.sliders.edit','dashboard.sliders.destroy']))
                    ...
                    @foreach($sliders as $slider)
                        <tr id="row-{{ $slider->id }}">
                            ...
                            <td>
                                @if($slider->image)
                                    <img src="{{ \Illuminate\Support\Facades\Storage::url($slider->image) }}" width="70"
                                         height="70" alt="">
                                @else
                                    -
                                @endif
                            ...
                            <!--end::Customer=-->
                            <!--begin::Date=-->
                            <td>{{ \App\Models\Slider::TYPES[$slider->type] }}</td>
                            <td>
                                @if($slider->link)
                                    <div
                                        class="badge badge-success">
                                        <a href="{{ $slider->link }}">View</a>
                                    </div>
                                @else
                            ...
                            @canany(get_permission(['dashboard.sliders.edit','dashboard.sliders.destroy']))
                                <td>
                                    ...
                                    <div
                                        class="menu menu-sub menu-sub-dropdown menu-column menu-rounded menu-gray-600 menu-state-bg-light-primary fw-bold fs-7 w-125px py-4"
                                        data-kt-menu="true">
                                        @can(get_permission('dashboard.sliders.edit'))
                                            <div class="menu-item px-3">
                                        ...
                                        @endcan
                                        @can(get_permission('dashboard.sliders.destroy'))
                                        <!--begin::Menu item-->
                                            <div class="menu-item px-3">
                                                <a data-url="{{ route('dashboard.sliders.destroy', $slider) }}"
        ...
        <!--end::Card-->
    @else
        @include('dashboard.includes.no-items',['module' => 'slider','route' => route('dashboard.sliders.create'),'list_route' => route('dashboard.sliders.index')])
    @endif

    @include('dashboard.includes.delete-modal',['action_message' => 'slider'])
@endsection
