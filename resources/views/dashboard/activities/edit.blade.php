...
@section('content')
    ...
    <form id="kt_add_form" class="form fv-plugins-bootstrap5 fv-plugins-framework"
          ...
          action="{{ route('dashboard.activities.update', $activity) }}" data-reload="1" method="POST">
        @method('PUT')
                        ...
                        <div class="row">
                            <div class="col-6">
                                ...
                                <div class="fv-row mb-10 fv-plugins-icon-container">
                                    ...
                                    <label class="fs-5 fw-bolder form-label mb-2">
                                        <span class="required">
                                            <a href="{{ \Illuminate\Support\Facades\Storage::url($activity->thumbnail) }}"
                                               target="_blank">
                                                Show Thumbnail
                                            </a>
                                        </span>
                            ...
                            <div class="col-6">
                                ...
                                <div class="fv-row mb-10 fv-plugins-icon-container">
                                    ...
                                    <label class="fs-5 fw-bolder form-label mb-2">
                                        <span class="required">
                                            <a href="{{ \Illuminate\Support\Facades\Storage::url($activity->image) }}"
                                               target="_blank">
                                                Show Image
                                            </a>
                                        </span>
                                ...
                                <div class="col-6">
                                    ...
                                    <div class="fv-row mb-10 fv-plugins-icon-container">
                                        ...
                                        <input class="form-control form-control-solid"
                                               ...
                                               placeholder="Enter a title" value="{{ $activity->title($language->code) }}">
                                        <!--end::Input-->
                                        <div class="fv-plugins-message-container invalid-feedback"></div>
                                    </div>
                                    <!--end::Input group-->
                                ...
                                <div class="col-6">
                                    ...
                                    <div class="fv-row mb-10 fv-plugins-icon-container">
                                        ...
                                        <textarea class="form-control form-control-solid" rows="5"
                                                  ...
                                                  placeholder="Enter a description">{{ $activity->description($language->code) }}</textarea>
                                        <!--end::Input-->
                                        <div class="fv-plugins-message-container invalid-feedback"></div>
                                    </div>
                                    <!--end::Input group-->
                                ...
                                <div class="col-6">
                                    ...
                                    <div class="fv-row mb-10 fv-plugins-icon-container">
                                        ...
                                        <input class="form-control form-control-solid"
                                               ...
                                               value="{{ $activity->author($language->code) }}">
                                        <!--end::Input-->
                                        <div class="fv-plugins-message-container invalid-feedback"></div>
                                    </div>
                                    <!--end::Input group-->
