    ...
    <div class="card card-flush pt-3 mb-5 mb-lg-10" data-kt-subscriptions-form="pricing">
        ...
        <div class="card-body pt-0">
            ...
            <form id="kt_add_role_form" class="form fv-plugins-bootstrap5 fv-plugins-framework"
                  ...
                  action="{{ route('dashboard.roles.update',$role) }}" data-reload="1">
            @method('PUT')
            <!--begin::Scroll-->
                                    ...
                                    <td>
                                        ...
                                        <label class="form-check form-check-custom form-check-solid me-9">
                                            <input class="form-check-input" type="checkbox" value=""
                                                   ...
                                                   @if($role->permissions->count() === $permissions->sum(fn($permission) => count($permission))) checked @endif>
                                ...
                                @foreach($permissions->sortByDesc(fn($q) => $q->count()) as $module => $module_permissions)
                                    ...
                                    <tr @if(in_array($module,['home','profile'])) class="d-none" @endif>
                                        ...
                                        <td>
                                            <!--begin::Wrapper-->
                                            <div class="d-flex">
                                            @foreach($module_permissions->sortBy('id') as $permission)
                                                <!--begin::Checkbox-->
                                                    <label
                                                        ...
                                                        <input
                                                            ...
                                                            type="checkbox"
                                                            name="permissions[]"
                                                            @if(in_array($module,['home','profile']) || $role->permissions->contains('id', $permission->id))
                                                            checked
                                                            @endif
                                                            value="{{ $permission->id }}">
