    ...
    <ul class="breadcrumb breadcrumb-dot fw-bold text-gray-600 fs-7 my-1">
        ...
        <li class="breadcrumb-item text-gray-600">
            <a href="{{ route('dashboard.news.index') }}"
               class="text-gray-600 text-hover-primary">News</a>
        </li>
        <!--end::Item-->
        <!--begin::Item-->
        <li class="breadcrumb-item text-gray-600">
...
@section('content')
    ...
    <form id="kt_add_form" class="form fv-plugins-bootstrap5 fv-plugins-framework"
          data-list-route="{{ route('dashboard.news.index') }}"
          action="{{ route('dashboard.news.update', $news) }}" data-reload="1" method="POST">
        @method('PUT')
        <div class="card card-flush pt-3 mb-5 mb-lg-10" data-kt-subscriptions-form="pricing">
            ...
            <div class="card-header">
                ...
                <div class="card-title">
                    <h2 class="fw-bolder">News Information</h2>
                </div>
                <!--begin::Card title-->
            </div>
            <!--end::Card header-->
                        ...
                        <div class="row">
                            <div class="col-6">
                                ...
                                <div class="fv-row mb-10 fv-plugins-icon-container">
                                    ...
                                    <label class="fs-5 fw-bolder form-label mb-2">
                                        <span class="required">
                                            <a href="{{ \Illuminate\Support\Facades\Storage::url($news->thumbnail) }}"
                                               target="_blank">
                                                Show Thumbnail
                                            </a>
                                        </span>
                            ...
                            <div class="col-6">
                                ...
                                <div class="fv-row mb-10 fv-plugins-icon-container">
                                    ...
                                    <label class="fs-5 fw-bolder form-label mb-2">
                                        <span class="required">
                                            <a href="{{ \Illuminate\Support\Facades\Storage::url($news->image) }}"
                                               target="_blank">
                                                Show Image
                                            </a>
                                        </span>
                                ...
                                <div class="col-6">
                                    ...
                                    <div class="fv-row mb-10 fv-plugins-icon-container">
                                        ...
                                        <input class="form-control form-control-solid"
                                               ...
                                               placeholder="Enter a title" value="{{ $news->title($language->code) }}">
                                        <!--end::Input-->
                                        <div class="fv-plugins-message-container invalid-feedback"></div>
                                    </div>
                                    <!--end::Input group-->
                            ...
                            @foreach($languages as $key => $language)
                                <div class="col-6">
                                    ...
                                    <div class="fv-row mb-10 fv-plugins-icon-container">
                                        ...
                                        <!--end::Label-->
                                        <!--begin::Input-->
                                        <textarea class="form-control form-control-solid summernote" rows="5"
                                                  name="translated_attributes[{{ $language->id }}][description]"
                                                  placeholder="Enter a description">{{ $news->description($language->code) }}</textarea>
                                        <!--end::Input-->
                                        <div class="fv-plugins-message-container invalid-feedback"></div>
                                    </div>
                                    <!--end::Input group-->
                                ...
                                <div class="col-6">
                                    ...
                                    <div class="fv-row mb-10 fv-plugins-icon-container">
                                        ...
                                        <input class="form-control form-control-solid"
                                               ...
                                               value="{{ $news->author($language->code) }}">
                                        <!--end::Input-->
                                        <div class="fv-plugins-message-container invalid-feedback"></div>
                                    </div>
                                    <!--end::Input group-->
...
@section('scripts')
    ...
    <script src="{{ asset('assets/js/dashboard/news/create.js') }}"></script>
@endsection
