...
@section('content')
    ...
    <form id="kt_add_form" class="form fv-plugins-bootstrap5 fv-plugins-framework"
          data-list-route="{{ route('dashboard.committees.index') }}"
          action="{{ route('dashboard.committees.update', $committee) }}" data-reload="1" method="POST">
        @method('PUT')
        <div class="card card-flush pt-3 mb-5 mb-lg-10" data-kt-subscriptions-form="pricing">
            ...
            <div class="card-header">
                ...
                <div class="card-title">
                    <h2 class="fw-bolder">Committee Information</h2>
                </div>
                <!--begin::Card title-->
            </div>
            <!--end::Card header-->
                                ...
                                <div class="col-6">
                                    ...
                                    <div class="fv-row mb-10 fv-plugins-icon-container">
                                        ...
                                        <input class="form-control form-control-solid"
                                               ...
                                               value="{{ $committee->title($language->code) }}">
                                        <!--end::Input-->
                                ...
                                <div class="col-6">
                                    ...
                                    <div class="fv-row mb-10 fv-plugins-icon-container">
                                        ...
                                        <textarea class="form-control form-control-solid" rows="5"
                                                  ...
                                                  placeholder="Enter a description">{{ $committee->brief($language->code) }}</textarea>
                                        <!--end::Input-->
                                        <div class="fv-plugins-message-container invalid-feedback"></div>
                                    </div>
                                    <!--end::Input group-->
...
@section('scripts')
    <script src="{{ asset('assets/js/dashboard/committees/create.js') }}"></script>
@endsection
