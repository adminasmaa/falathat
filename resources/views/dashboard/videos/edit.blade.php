    ...
    <ul class="breadcrumb breadcrumb-dot fw-bold text-gray-600 fs-7 my-1">
        ...
        <li class="breadcrumb-item text-gray-600">
            <a href="{{ route('dashboard.videos.index') }}"
               class="text-gray-600 text-hover-primary">Videos</a>
        </li>
        <!--end::Item-->
        <!--begin::Item-->
        <li class="breadcrumb-item text-gray-600">
...
@section('content')
    ...
    <form id="kt_add_form" class="form fv-plugins-bootstrap5 fv-plugins-framework"
          data-list-route="{{ route('dashboard.videos.index') }}"
          action="{{ route('dashboard.videos.update', $video) }}" data-reload="1" method="POST">
        @method('PUT')
        <div class="card card-flush pt-3 mb-5 mb-lg-10" data-kt-subscriptions-form="pricing">
            ...
            <div class="card-header">
                ...
                <div class="card-title">
                    <h2 class="fw-bolder">Video Information</h2>
                </div>
                <!--begin::Card title-->
            </div>
            <!--end::Card header-->
                            ...
                            <div class="col-6">
                                ...
                                <div class="fv-row mb-10 fv-plugins-icon-container">
                                    ...
                                    <label class="fs-5 fw-bolder form-label mb-2">
                                        <span class="required">
                                            <a href="{{ \Illuminate\Support\Facades\Storage::url($video->thumbnail) }}"
                                               target="_blank">
                                                Show Thumbnail
                                            </a>
                                        </span>
