...
@section('content')
    ...
    <form id="kt_add_form" class="form fv-plugins-bootstrap5 fv-plugins-framework"
          ...
          action="{{ route('dashboard.branches.store') }}" data-reload="1" method="POST">
                                ...
                                <div class="fv-row mb-10 fv-plugins-icon-container">
                                    ...
                                    <select class="form-control form-control-solid" name="parent" id="parent">
                                        ...
                                        @foreach($branches as $single_branch)
                                            <option value="{{ $single_branch->id }}">{{ $single_branch->title('ar') }}</option>
                                        @endforeach
                                    </select>
                                    <!--end::Input-->
                                    <div class="fv-plugins-message-container invalid-feedback"></div>
                                ...
                                <div class="col-6">
                                    ...
                                    <div class="fv-row mb-10 fv-plugins-icon-container">
                                        ...
                                        <textarea class="form-control form-control-solid" rows="5"
                                                  ...
                                                  placeholder="Enter a achievements"></textarea>
                                        <!--end::Input-->
                                        <div class="fv-plugins-message-container invalid-feedback"></div>
                                    </div>
                                    <!--end::Input group-->
                                ...
                                <div class="col-6">
                                    ...
                                    <div class="fv-row mb-10 fv-plugins-icon-container">
                                        ...
                                        <textarea class="form-control form-control-solid" rows="5"
                                                  ...
                                                  placeholder="Enter a opinions & rates"></textarea>
                                        <!--end::Input-->
                                        <div class="fv-plugins-message-container invalid-feedback"></div>
                                    </div>
                                    <!--end::Input group-->
