...
@section('breadcrumb')
    <!--begin::Title-->
    <h1 class="d-flex text-dark fw-bolder my-1 fs-3">Messages Management</h1>
    <!--end::Title-->
    <!--begin::Breadcrumb-->
    <ul class="breadcrumb breadcrumb-dot fw-bold text-gray-600 fs-7 my-1">
        ...
        <!--end::Item-->
        <!--begin::Item-->
        <li class="breadcrumb-item text-gray-600">Messages</li>
        <!--end::Item-->
    </ul>
    <!--end::Breadcrumb-->
@endsection
...
@section('actions')
    ...
    <div class="me-3">
        ...
        <div class="menu menu-sub menu-sub-dropdown w-700px w-md-750px" data-kt-menu="true"
            ...
            <!--end::Menu separator-->
            <!--begin::Form-->
            <form id="search" action="{{ route('dashboard.messages.index') }}">
                <div class="px-7 py-5">
                    <div class="row">
                        <div class="col-6">
                            <!--begin::Input group-->
            ...
            <div class="col-xl-6">
                ...
                <div class="card bg-light-primary card-xl-stretch mb-5 mb-xl-8">
                    ...
                    <div class="card-body my-3">
                        <a href="#" class="card-title fw-bolder text-primary fs-5 mb-3 d-block">Total Messages</a>
                        <div class="py-1">
                            <span class="text-dark fs-1 fw-bolder me-2">{{ (clone $messagesQuery)->count() }}</span>
                        </div>
                    </div>
                    <!--end:: Body-->
                </div>
            ...
            <div class="card-header border-0 pt-6">
                ...
                <div class="card-toolbar">
                    ...
                    <div class="d-flex justify-content-end" data-kt-customer-table-toolbar="base">
                        @canany(get_permission(['dashboard.bulk.messages.delete']))
                            ...
                            <div
                                ...
                                data-kt-menu="true">
                                @can(get_permission('dashboard.bulk.messages.delete'))
                                    <div class="menu-item px-3">
                                        <a data-url="{{ route('dashboard.bulk.messages.delete') }}"
            ...
            <div class="card-body pt-0" style="overflow: scroll;width: 100%;">
                ...
                <table class="table align-middle table-row-dashed fs-6 gy-5" id="kt_subscriptions_table">
                    ...
                    <tr class="text-start text-muted fw-bolder fs-7 text-uppercase gs-0">
                        ...
                        @canany(get_permission(['dashboard.messages.destroy']))
                    ...
                    @foreach($messages as $message)
                        <tr id="row-{{ $message->id }}">
                            ...
                            <!--begin::Billing=-->
                            <td>
                                <div class="badge badge-light">{{ $message->email }}</div>
                            </td>
                            <!--end::Billing=-->
                            <!--end::Customer=-->
                            <!--begin::Customer=-->
                            <td>{{ \App\Models\Message::TYPES[$message->contact_type] }}</td>
                            <!--end::Customer=-->
                            <!--begin::Customer=-->
                            ...
                            @canany(get_permission(['dashboard.messages.destroy']))
                                <td class="text-end">
                                    ...
                                    <div
                                        class="menu menu-sub menu-sub-dropdown menu-column menu-rounded menu-gray-600 menu-state-bg-light-primary fw-bold fs-7 w-125px py-4"
                                        data-kt-menu="true">
                                    @can(get_permission('dashboard.messages.destroy'))
                                        <!--begin::Menu item-->
                                            <div class="menu-item px-3">
                                                <a data-url="{{ route('dashboard.messages.destroy', $message) }}"
                ...
                <!--end::Table-->
                {!! $messages->appends(request()->except('page'))->links('vendor.pagination.default') !!}
            </div>
            <!--end::Card body-->
        </div>
        <!--end::Card-->
    @else
        @include('dashboard.includes.no-items',['module' => 'message','list_route' => route('dashboard.messages.index')])
    @endif

    @include('dashboard.includes.delete-modal',['action_message' => 'message'])
@endsection
