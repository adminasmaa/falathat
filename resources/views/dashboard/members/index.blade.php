...
@section('actions')
    ...
    <div class="me-3">
        ...
        <div class="menu menu-sub menu-sub-dropdown w-700px w-md-750px" data-kt-menu="true"
            ...
            <!--end::Menu separator-->
            <!--begin::Form-->
            <form id="search" action="{{ route('dashboard.members.index') }}">
                <div class="px-7 py-5">
                    <div class="row">
                        <div class="col-6">
                            <!--begin::Input group-->
    ...
    <!--end::Wrapper-->
    @can(get_permission('dashboard.members.create'))
        <!--begin::Button-->
        <a href="{{ route('dashboard.members.create') }}" class="btn btn-dark fw-bolder"
...
@section('content')
    ...
    @if($members->count())
            ...
            <div class="card-header border-0 pt-6">
                ...
                <div class="card-toolbar">
                    ...
                    <div class="d-flex justify-content-end" data-kt-customer-table-toolbar="base">
                        @canany(get_permission(['dashboard.bulk.members.delete']))
                            ...
                            <div
                                ...
                                data-kt-menu="true">
                                @can(get_permission('dashboard.bulk.members.delete'))
                                    <div class="menu-item px-3">
                                        <a data-url="{{ route('dashboard.bulk.members.delete') }}"
            ...
            <div class="card-body pt-0" style="overflow: scroll;width: 100%;">
                ...
                <table class="table align-middle table-row-dashed fs-6 gy-5" id="kt_subscriptions_table">
                    ...
                    <tr class="text-start text-muted fw-bolder fs-7 text-uppercase gs-0">
                        ...
                        <th class="min-w-50px">CEO</th>
                        <th class="min-w-50px">Creation Date</th>
                        @canany(get_permission(['dashboard.members.edit','dashboard.members.destroy']))
                    ...
                    @foreach($members as $member)
                        <tr id="row-{{ $member->id }}">
                            ...
                            <!--begin::Date=-->
                            <td>{{ \App\Models\Member::TYPES[$member->type] }}</td>
                            <td>{{ $member->phone ?: '-' }}</td>
                            <td>{{ $member->email ?: '-' }}</td>
                            <td>
                                @if($member->CEO)
                            ...
                            @canany(get_permission(['dashboard.members.edit','dashboard.members.destroy']))
                                <td>
                                    ...
                                    <div
                                        class="menu menu-sub menu-sub-dropdown menu-column menu-rounded menu-gray-600 menu-state-bg-light-primary fw-bold fs-7 w-125px py-4"
                                        data-kt-menu="true">
                                        @can(get_permission('dashboard.members.edit'))
                                            <div class="menu-item px-3">
                                        ...
                                        @endcan
                                        @can(get_permission('dashboard.members.destroy'))
                                        <!--begin::Menu item-->
                                            <div class="menu-item px-3">
                                                <a data-url="{{ route('dashboard.members.destroy', $member) }}"
        ...
        <!--end::Card-->
    @else
        @include('dashboard.includes.no-items',['module' => 'member','route' => route('dashboard.members.create'),'list_route' => route('dashboard.members.index')])
    @endif
