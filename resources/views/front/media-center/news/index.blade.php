...
@section('breadcrumbs')
    <li class="breadcrumb-item hover-light text-bold">
        {{ $settings['Translations']['media_center_news'] }}
    </li>
@endsection

@section('content')
    <!--Page Header-->
    @include('front.includes.page-header', ['currentPage' => $settings['Translations']['media_center_news']])

    <section id="news_general" class="padding">
        <div class="container">
            <div class="row">
                <div class="col-md-12 text-center animated wow fadeIn" data-wow-delay="300ms">
                    <h2 class="heading bottom45 darkcolor font-weight-normal"> {{ $settings['Translations']['news_page_media_section_title'] }}
                ...
                @foreach($news as $single_news)
                    <div class="col-lg-4 col-md-6 col-sm-12">
                        <figure class="image-block">
                            <h1>{{ $single_news->title('ar') }}</h1>

                            <ul class="meta-tags position-absolute ">
                                <li>
                                    <a href="#." class="text-white"><i class="fas fa-calendar-alt mx-2"></i>
                                        {{ \App\Models\Activity::DataFormat($single_news->created_at) }}
                                    </a>
                                </li>
                                <li>
                                    <a href="{{ route('front.news.show', $single_news) }}" class="text-white">
                            ...
                            <div class="imageContainer"
                                 style="background-image: url('{{ Storage::url($single_news->thumbnail) }}');">
                            ...
                            <figcaption>
                                <div class="position-relative">
                                    ...
                                    <a href="#." class=" userName text-white position-absolute top"> <i
                                            class="far fa-user mx-2"></i> {{ $single_news->author('ar') }} </a>
                                    <p>{{ Str::limit(strip_tags($single_news->description('ar')), 100, ' ...') }}</p>
                                    <button class="button gradient-btn"
                                            onclick="window.location.href = '{{ route('front.news.show', $single_news) }}'">
