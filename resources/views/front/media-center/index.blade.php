...
@section('breadcrumbs')
    <li class="breadcrumb-item hover-light text-bold">
        {{ $settings['Translations']['media'] }}
    </li>
@endsection

@section('content')
    <!--Page Header-->
    @include('front.includes.page-header', ['currentPage' => $settings['Translations']['media']])
    ...
    <section id="news_general" class="padding">
        <div class="container">
            <ol class="articles">
                ...
                <li class="articles__article before-orange" style="--animation-order: 1;">
                    <a href="{{ route('front.news.index') }}" class="articles__link after-orange">
                        <div
                            class="articles__content bg-orange articles__content--lhs d-flex align-items-center justify-content-center">
                            <h2 class="articles__title text-center">{{ $settings['Translations']['media_center_news'] }}</h2>
                        </div>
                        <div
                            class="articles__content bg-orange articles__content--rhs d-flex align-items-center justify-content-center"
                            aria-hidden="true">
                            <h2 class="articles__title text-center">{{ $settings['Translations']['media_center_news'] }}</h2>
                        </div>
                    </a>
                ...
                <li class="articles__article " style="--animation-order: 2;">
                    <a href="{{ route('front.media.index') }}" class="articles__link">
                        <div
                            class="articles__content articles__content--lhs d-flex align-items-center justify-content-center">
                            <h2 class="articles__title text-center">{{ $settings['Translations']['media_center_media'] }}</h2>
                        </div>
                        <div
                            class="articles__content articles__content--rhs d-flex align-items-center justify-content-center"
                            aria-hidden="true">
                            <h2 class="articles__title text-center">{{ $settings['Translations']['media_center_media'] }}</h2>
                        </div>
                    </a>
                </li>
                <li class="articles__article before-green" style="--animation-order: 3;">
                    <a href="{{ route('front.reports.index') }}" class="articles__link after-green">
                        <div
                            class="articles__content bg-green articles__content--lhs d-flex align-items-center justify-content-center">
                            <h2 class="articles__title text-center">{{ $settings['Translations']['media_center_reports'] }}</h2>
                        </div>
                        <div
                            class="articles__content bg-green articles__content--rhs d-flex align-items-center justify-content-center"
                            aria-hidden="true">
                            <h2 class="articles__title text-center">{{ $settings['Translations']['media_center_reports'] }}</h2>
                        </div>
                    </a>
                </li>
                <li class="articles__article before-light-blue" style="--animation-order: 3;">
                    <a href="{{ route('front.activities.index') }}" class="articles__link after-light-blue">
                        <div
                            class="articles__content bg-light-blue articles__content--lhs d-flex align-items-center justify-content-center">
                            <h2 class="articles__title text-center">{{ $settings['Translations']['media_center_activities'] }}</h2>
                        </div>
                        <div
                            class="articles__content bg-light-blue articles__content--rhs d-flex align-items-center justify-content-center"
                            aria-hidden="true">
                            <h2 class="articles__title text-center">{{ $settings['Translations']['media_center_activities'] }}</h2>
                        </div>
                    </a>
                </li>
                <li class="articles__article before-yellow" style="--animation-order: 3;">
                    <a href="#!" class="articles__link after-yellow">
                        <div
                            class="articles__content bg-yellow articles__content--lhs d-flex align-items-center justify-content-center">
                            <h2 class="articles__title text-center">{{ $settings['Translations']['media_center_achievements'] }}</h2>
                        </div>
                        <div
                            class="articles__content bg-yellow articles__content--rhs d-flex align-items-center justify-content-center"
                            aria-hidden="true">
                            <h2 class="articles__title text-center">{{ $settings['Translations']['media_center_achievements'] }}</h2>
                        </div>
                    </a>
