...
@section('content')
    <!--Page Header-->
    @include('front.includes.page-header', ['currentPage' => $settings['Translations']['committee']])
        ...
        <div class="container">
            <ol class="articles">
                ...
                @foreach($committees as $committee)
                    ...
                    <li class="articles__article before-{{ $colors[$color] }}" style="--animation-order: 1;">
                        <a href="{{ route('front.committees.show', $committee) }}"
                           class="articles__link after-{{ $colors[$color] }}">
                            <div
                                ...
                                <h2 class="articles__title text-center">
                                    {{ $settings['Translations']['committee_text'] }}
                                    <br>
                                    {{ $committee->title('ar') }}
                                </h2>
                            </div>
